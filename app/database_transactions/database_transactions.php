...
//invoke pre-render hook
	app::dispatch_list_pre_render('database_transaction_list_page_hook', $url, $template);
...
//invoke post-render hook
	app::dispatch_list_post_render('database_transaction_list_page_hook', $url, $html);
	echo $html;
