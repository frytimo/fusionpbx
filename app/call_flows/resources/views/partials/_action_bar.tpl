<script language='javascript' type='text/javascript'>
	function toggle_select() {
		$('#call_flow_feature').fadeToggle(400, function() {
			document.getElementById('call_flow_feature').selectedIndex = 0;
			document.getElementById('call_flow_feature').focus();
		});
	}
</script>
<div class='action_bar' id='action_bar'>
	<div class='heading'><b>{$text['title-call_flows']}</b><div class='count'>{$num_rows|number_format}</div></div>
	<div class='actions'>
		{$btn_add}
		{$btn_copy}
		{$btn_toggle}
