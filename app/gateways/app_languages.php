...
$text['label-supress_cng']['ka-ge'] = "CNG-ის ჩახშობა";
...
$text['label-status-stopped']['ka-ge'] = "გაჩერებულია";
...
$text['label-status-running']['ka-ge'] = "გაშვებულია";
...
$text['label-sip_cid_type']['ka-ge'] = "SIP CID-ის ტიპი";
...
$text['label-retry_seconds']['ka-ge'] = "თავიდან ცდა წამებში";
...
$text['label-register_transport']['ka-ge'] = "ტრანსპორტის რეგისტრაცია";
...
$text['label-contact_params']['ka-ge'] = "კონტაქტის პარამეტრები";
...
$text['label-register_proxy']['ka-ge'] = "რეგისტრაციის პროქსი";
...
$text['label-register']['ka-ge'] = "რეგისტრაცია";
...
$text['label-ping_min']['ka-ge'] = "მინ. პინგი";
...
$text['label-ping_max']['ka-ge'] = "მაქს. პინგი";
...
$text['label-contact_in_ping']['ka-ge'] = "კონტაქტი პინგში";
...
$text['label-outbound_proxy']['ka-ge'] = "გამავალი პროქსი";
...
$text['label-from_user']['ka-ge'] = "მომხმარებლისგან";
...
$text['label-from_domain']['ka-ge'] = "დომენიდან";
...
$text['label-extension_in_contact']['sv-se'] = "Anknytning i kontakt";
...
$text['label-expire_seconds']['ka-ge'] = "ვადა წამებში";
...
$text['label-distinct_to']['ka-ge'] = "განსხვავებული";
...
$text['label-codec_prefs']['ka-ge'] = "კოდეკის მორგება";
...
$text['label-caller_id_in_from']['ka-ge'] = "შემომავალი CID";
...
$text['label-auth_username']['ka-ge'] = "ავთენტიკაციის მომხმარებლის სახელი";
...
$text['label-action-stop']['ka-ge'] = "გაჩერება";
...
$text['label-action-start']['ka-ge'] = "გაშვება";
...
$text['description-username']['ka-ge'] = "აქ შეიყვანეთ მომხმარებლის სახელი.";
...
$text['description-supress_cng']['ka-ge'] = "შეიყვანეთ supress-cng";
...
$text['description-sip_cid_type']['ka-ge'] = "შეიყვანეთ SIP CID-ის ტიპი: none, pid და rpid.";
...
$text['description-retry_seconds']['ka-ge'] = "აქ შეიყვანეთ თავიდან ცდა წამებში.";
...
$text['description-register_transport']['ka-ge'] = "აირჩიეთ რეგისტრაციის ტრანსპორტი";
...
$text['description-contact_params']['ka-ge'] = "აქ შეიყვანეთ კონტაქტის პარამეტრები.";
...
$text['description-register_proxy']['ka-ge'] = "შეიყვანეთ რეგისტრაციის პროქსის ჰოსტი სახელი ან IP მისამართი. ჰოსტი[:პორტი]";
...
$text['description-register']['ka-ge'] = "აირჩიეთ, საჭიროა თუ არა დარეგისტრირება.";
...
$text['description-realm']['ka-ge'] = "აქ შეიყვანეთ რეალმი.";
...
$text['description-proxy']['ka-ge'] = "შეიყვანეთ პროქსის ჰოსტის სახელი ან IP მისამართი. ჰოსტი[:პორტი]";
...
$text['description-profile']['ka-ge'] = "აქ შეიყვანეთ პროფილი.";
...
$text['description-ping']['ka-ge'] = "აქ შეიყვანეთ პინგის ინტერვალი წამებში.";
...
$text['description-ping_min']['ka-ge'] = "შეიყვანეთ მინ. პინგის რაოდენობა. ეს წარმატებული პინგების რაოდენობაა, რომელიც უნდა მივიღოთ, სანამ კვანძს ჩართულად გამოვაცხადებთ.";
...
$text['description-ping_max']['ar-eg'] = "أدخل الحد الأقصى لعدد ping. بمجرد الوصول إلى قيمة ping max من خلال اختبارات ping الناجحة، سيتوقف العداد. إذا انخفضت الأصوات الناجحة إلى أقل من 3، فسيتم اعتبار البوابة معطلة.";
$text['description-ping_max']['de-at'] = "Geben Sie die maximale Ping-Anzahl ein. Sobald der Ping-Max-Wert bei erfolgreichen Pings erreicht ist, stoppt der Zähler. Wenn erfolgreiche Pings unter 3 fallen, gilt das Gateway als ausgefallen.";
$text['description-ping_max']['de-ch'] = "Geben Sie die maximale Ping-Anzahl ein. Sobald der Ping-Max-Wert bei erfolgreichen Pings erreicht ist, stoppt der Zähler. Wenn erfolgreiche Pings unter 3 fallen, gilt das Gateway als ausgefallen.";
$text['description-ping_max']['de-de'] = "Geben Sie die maximale Ping-Anzahl ein. Sobald der Ping-Max-Wert bei erfolgreichen Pings erreicht ist, stoppt der Zähler. Wenn erfolgreiche Pings unter 3 fallen, gilt das Gateway als ausgefallen.";
$text['description-ping_max']['el-gr'] = "Εισαγάγετε τον μέγιστο αριθμό ping. Μόλις επιτευχθεί η τιμή ping-max με επιτυχημένα ping, ο μετρητής θα σταματήσει. Εάν τα επιτυχημένα ping πέσουν κάτω από 3, η πύλη θα θεωρηθεί ως μηδενική.";
$text['description-ping_max']['es-cl'] = "Ingrese el recuento máximo de ping. Una vez que se alcanza el valor máximo de ping con pings exitosos, el contador se detendrá. Si los pings exitosos caen por debajo de 3, la puerta de enlace se considerará inactiva.";
$text['description-ping_max']['es-mx'] = "Ingrese el recuento máximo de ping. Una vez que se alcanza el valor máximo de ping con pings exitosos, el contador se detendrá. Si los pings exitosos caen por debajo de 3, la puerta de enlace se considerará inactiva.";
$text['description-ping_max']['fr-ca'] = "Entrez le nombre maximum de ping. Une fois que la valeur ping-max est atteinte avec des pings réussis, le compteur s'arrête. Si les pings réussis tombent en dessous de 3, la passerelle sera considérée comme indisponible.";
...
$text['description-ping_max']['pt-pt'] = "Insira a contagem máxima de ping. Assim que o valor ping-max for atingido com pings bem-sucedidos, o contador irá parar. Se os pings bem-sucedidos caírem abaixo de 3, o gateway será considerado inativo.";
$text['description-ping_max']['ro-ro'] = "Introduceți numărul maxim de ping. Odată ce valoarea ping-max este atinsă cu ping-uri reușite, contorul se va opri. Dacă ping-urile reușite scad sub 3, gateway-ul va fi considerat ca fiind inactiv.";
$text['description-ping_max']['ru-ru'] = "Введите максимальное количество пинга. Как только значение ping-max будет достигнуто при успешных пингах, счетчик остановится. Если успешные пинги упадут ниже 3, шлюз будет считаться отключенным.";
$text['description-ping_max']['sv-se'] = "Ange max ping-antalet. När ping-max-värdet har nåtts med framgångsrika pingar kommer räknaren att stanna. Om framgångsrika pingar faller under 3 kommer gatewayen att anses vara nedlagd.";
$text['description-ping_max']['uk-ua'] = "Введіть максимальну кількість пінгів. Після досягнення максимального значення ping за допомогою успішних ping лічильник зупиниться. Якщо успішні ping-запити опустяться нижче 3, шлюз вважатиметься непрацюючим.";
$text['description-ping_max']['tr-tr'] = "Maksimum ping sayısını girin. Başarılı pinglerle maksimum ping değerine ulaşıldığında sayaç duracaktır. Başarılı pingler 3'ün altına düşerse ağ geçidi kapalı kabul edilecektir.";
$text['description-ping_max']['zh-cn'] = "输入 ping 最大计数。 一旦成功 ping 达到 ping-max 值，计数器就会停止。 如果成功的 ping 值低于 3，则网关将被视为已关闭。";
$text['description-ping_max']['ja-jp'] = "ping の最大数を入力します。 ping が成功して ping 最大値に達すると、カウンターは停止します。 成功した ping が 3 を下回った場合、ゲートウェイはダウンしていると見なされます。";
$text['description-ping_max']['ko-kr'] = "핑 최대 횟수를 입력합니다. 성공적인 ping으로 ping-max 값에 도달하면 카운터가 중지됩니다. 성공적인 핑이 3 미만으로 떨어지면 게이트웨이가 다운된 것으로 간주됩니다.";
...
$text['description-password']['ka-ge'] = "აქ შეიყვანეთ პაროლი.";
...
$text['description-outbound_proxy']['ka-ge'] = "შეიყვანეთ გამავალი პროქსის ჰოსტის სახელი ან IP მისამართი. ჰოსტი[:პორტი]";
...
$text['description-gateway-edit']['ka-ge'] = "აღწერს კავშირს SIP პროვაიდერთან ან სხვა SIP სერვერთან.";
...
$text['description-from_user']['ka-ge'] = "აქ შეიყვანეთ აბონენტის მომხმარებლის სახელი.";
...
$text['description-from_domain']['ka-ge'] = "აქ შეიყვანეთ აბონენტის დომენის სახელი.";
...
$text['description-expire_seconds']['ka-ge'] = "აქ შეიყვანეთ ვადა წამებში.";
...
$text['description-hostname']['ka-ge'] = "შეიყვანეთ ჰოსტს სახელი / კომუტატორის სახელი.";
...
$text['description-distinct_to']['ka-ge'] = "აქ შეიყვანეთ distinct_to.";
...
$text['description-context']['ka-ge'] = "აქ შეიყვანეთ კონტექსტი.";
...
$text['description-codec_prefs']['ka-ge'] = "შეიყვანეთ კოდეკის პრიორიტეტები სიის სახით. მაგ: PCMA,PCMU,G722";
...
$text['description-contact_in_ping']['ka-ge'] = "აირჩეთ, ჩავამტო თუ არა კონტაქტი პინგში.";
...
$text['description-channels']['ka-ge'] = "კვანძში ხელმისაწვდომი ერთდროული არხების მაქს. რაოდენობა.";
...
$text['description-caller_id_in_from']['ka-ge'] = "შეიყვანეთ caller-id-in-from.";
...
$text['description-auth_username']['ka-ge'] = "აქ შეიყვანეთ ავთენტკაციის მომხმარებლის სახელი.";
