<?php
	...
	//default settings
		...
		$y++;
		$apps[$x]['default_settings'][$y]['default_setting_uuid'] = "0fbe03bd-785c-422a-b0f2-5e6c44b8e222";
		$apps[$x]['default_settings'][$y]['default_setting_category'] = "provision";
		$apps[$x]['default_settings'][$y]['default_setting_subcategory'] = "snom_quick_transfer";
		$apps[$x]['default_settings'][$y]['default_setting_name'] = "text";
		$apps[$x]['default_settings'][$y]['default_setting_value'] = "new_call";
		$apps[$x]['default_settings'][$y]['default_setting_enabled'] = "true";
		$apps[$x]['default_settings'][$y]['default_setting_description'] = "Call Transfer via BLF. Valid options are: new_call, blind, attended See https://service.snom.com/display/wiki/quick_transfer";
		$y++;
		...
		$y++;
		$apps[$x]['default_settings'][$y]['default_setting_uuid'] = "8660b1a8-2cb6-4f7f-b8d8-f5f08d4aa787";
		$apps[$x]['default_settings'][$y]['default_setting_category'] = "provision";
		$apps[$x]['default_settings'][$y]['default_setting_subcategory'] = "snom_transfer_dialing_on_transfer";
		$apps[$x]['default_settings'][$y]['default_setting_name'] = "text";
		$apps[$x]['default_settings'][$y]['default_setting_value'] = "blind";
		$apps[$x]['default_settings'][$y]['default_setting_enabled'] = "true";
		$apps[$x]['default_settings'][$y]['default_setting_description'] = "Call Transfer via transfer-key. Valid options are: blind, attended See https://service.snom.com/display/wiki/transfer_dialing_on_transfer";
		$y++;
		$apps[$x]['default_settings'][$y]['default_setting_uuid'] = "4cb606ab-2016-4243-b425-9c84a4da0bbe";
		$apps[$x]['default_settings'][$y]['default_setting_category'] = "provision";
		$apps[$x]['default_settings'][$y]['default_setting_subcategory'] = "snom_transfer_dialing_on_other";
		$apps[$x]['default_settings'][$y]['default_setting_name'] = "text";
		$apps[$x]['default_settings'][$y]['default_setting_value'] = "blind";
		$apps[$x]['default_settings'][$y]['default_setting_enabled'] = "true";
		$apps[$x]['default_settings'][$y]['default_setting_description'] = "Call Transfer via ok-key. Valid options are: blind, attended See https://service.snom.com/display/wiki/transfer_dialing_on_other";
		$y++;
