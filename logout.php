...
//call the logout event classes before destroying the session
...
//call the logout event classes after destroying the session
	foreach ($classes as $class) {
		$class::on_logout_post_destroy($settings);
	}
