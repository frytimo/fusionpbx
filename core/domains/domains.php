...
//show the content
	...
	if ($has_domain_edit && !empty($domains)) {
 	...
 	if ($has_domain_delete && !empty($domains)) {
	...
	if ($has_domain_edit || $has_domain_delete) {
	...
	if ($has_domain_edit && $list_row_edit_button) {
