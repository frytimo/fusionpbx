...
$text['message-domain_exists']['tr-tr'] = "Etki alanı zaten var";
...
$text['confirm-toggle_domains']['de-ch'] = "Sind Sie sicher, dass Sie diese Domänen umschalten möchten?";
$text['confirm-toggle_domains']['de-de'] = "Sind Sie sicher, dass Sie diese Domänen umschalten möchten?";
$text['confirm-toggle_domains']['el-gr'] = "Είστε σίγουροι ότι θέλετε να εναλλάξετε αυτούς τους τομείς;";
$text['confirm-toggle_domains']['es-cl'] = "¿Está seguro de que desea alternar estos dominios?";
$text['confirm-toggle_domains']['es-mx'] = "¿Está seguro de que desea alternar estos dominios?";
$text['confirm-toggle_domains']['fr-ca'] = "Êtes-vous sûr de vouloir basculer ces domaines ?";
$text['confirm-toggle_domains']['fr-fr'] = "Êtes-vous sûr de vouloir basculer ces domaines ?";
$text['confirm-toggle_domains']['he-il'] = "האם אתה בטוח שאתה רוצה ל.Toggle את הדומייניםเหล่านี้?";
$text['confirm-toggle_domains']['it-it'] = "Sei sicuro di voler attivare/disattivare questi domini?";
$text['confirm-toggle_domains']['ka-ge'] = "დარწმუნებად გიხმარებათ, რომ გსურთ ამ დომენების გამორთვა/ჩართვა?";
$text['confirm-toggle_domains']['nl-nl'] = "Weet u zeker dat u deze domeinen wilt in- of uitzetten?";
$text['confirm-toggle_domains']['pl-pl'] = "Czy na pewno chcesz przełączyć te domeny?";
$text['confirm-toggle_domains']['pt-br'] = "Tem certeza de que deseja alternar esses domínios?";
$text['confirm-toggle_domains']['pt-pt'] = "Tem a certeza de que quer ligar/desligar estes domínios?";
$text['confirm-toggle_domains']['ro-ro'] = "Sunteți sigur că doriți să comutați aceste domenii?";
$text['confirm-toggle_domains']['ru-ru'] = "Вы уверены, что хотите переключить эти домены?";
$text['confirm-toggle_domains']['sv-se'] = "Är du säker på att du vill växla dessa domäner?";
$text['confirm-toggle_domains']['uk-ua'] = "Ви впевнені, що хочете перемкнути ці домени?";
$text['confirm-toggle_domains']['tr-tr'] = "Bu etki alanlarını değiştirmek istediğinize emin misiniz?";
$text['confirm-toggle_domains']['zh-cn'] = "您确定要切换这些域吗？";
$text['confirm-toggle_domains']['ja-jp'] = "これらのドメインを切り替えますか？";
...
$text['confirm-delete_domains']['de-ch'] = "Sind Sie sicher, dass Sie diese Domänen löschen möchten?";
$text['confirm-delete_domains']['de-de'] = "Sind Sie sicher, dass Sie diese Domänen löschen möchten?";
$text['confirm-delete_domains']['el-gr'] = "Είστε σίγουροι ότι θέλετε να διαγράψετε αυτούς τους τομείς;";
$text['confirm-delete_domains']['es-cl'] = "¿Está seguro de que desea eliminar estos dominios?";
$text['confirm-delete_domains']['es-mx'] = "¿Está seguro de que desea eliminar estos dominios?";
$text['confirm-delete_domains']['fr-ca'] = "Êtes-vous sûr de vouloir supprimer ces domaines ?";
$text['confirm-delete_domains']['fr-fr'] = "Êtes-vous sûr de vouloir supprimer ces domaines ?";
$text['confirm-delete_domains']['he-il'] = "האם אתה בטוח שאתה רוצה להסיר את הדומייניםเหล่านี้?";
$text['confirm-delete_domains']['it-it'] = "Sei sicuro di voler eliminare questi domini?";
$text['confirm-delete_domains']['ka-ge'] = "დარწმუნებად გიხმარებათ, რომ გსურთ ამ დომენებს წაშლა?";
$text['confirm-delete_domains']['nl-nl'] = "Weet u zeker dat u deze domeinen wilt verwijderen?";
$text['confirm-delete_domains']['pl-pl'] = "Czy na pewno chcesz usunąć te domeny?";
$text['confirm-delete_domains']['pt-br'] = "Tem certeza de que deseja excluir esses domínios?";
$text['confirm-delete_domains']['pt-pt'] = "Tem a certeza de que quer eliminar estes domínios?";
$text['confirm-delete_domains']['ro-ro'] = "Sunteți sigur că doriți să ștergeți aceste domenii?";
$text['confirm-delete_domains']['ru-ru'] = "Вы уверены, что хотите удалить эти домены?";
$text['confirm-delete_domains']['sv-se'] = "Är du säker på att du vill ta bort dessa domäner?";
$text['confirm-delete_domains']['uk-ua'] = "Ви впевнені, що хочете видалити ці домени?";
$text['confirm-delete_domains']['tr-tr'] = "Bu etki alanlarını silmek istediğinize emin misiniz?";
$text['confirm-delete_domains']['zh-cn'] = "您确定要删除这些域吗？";
$text['confirm-delete_domains']['ja-jp'] = "これらのドメインを削除しますか？";
...
$text['header-domain_settings']['tr-tr'] = "Etki Alanı Ayarları";
...
$text['header-domain-add']['tr-tr'] = "Etki Alanı Ekle";
