...
$text['label-remember_me']['el-gr'] = "Να με θυμάσαι";
...
$text['label-remember_me']['ka-ge'] = "დამიმახსოვრე";
$text['label-remember_me']['nl-nl'] = "Onthoud mij";
$text['label-remember_me']['pl-pl'] = "Zapamiętaj mnie";
$text['label-remember_me']['pt-br'] = "Lembre-me";
$text['label-remember_me']['pt-pt'] = "Lembrar-me";
...
$text['label-remember_me']['uk-ua'] = "Запам'ятати мене";
$text['label-remember_me']['tr-tr'] = "Beni hatırla";
$text['label-remember_me']['zh-cn'] = "记住我";
$text['label-remember_me']['ja-jp'] = "ログイン状態を保持";
$text['label-remember_me']['ko-kr'] = "로그인 상태 유지";
