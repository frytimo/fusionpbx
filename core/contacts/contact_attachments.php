...
//check permissions
	...
	$has_contact_attachment_edit   = permission_exists('contact_attachment_edit');
...
//show if exists
	if (!empty($contact_attachments)) {
		...
		//show the content
			...
			if ($has_contact_attachment_edit && $list_row_edit_button == 'true') {
			...
			if (!empty($contact_attachments)) {
				...
				foreach ($contact_attachments as $row) {
					...
					$list_row_url = '';
					if ($has_contact_attachment_edit) {
