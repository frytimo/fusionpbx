<?php
	...
	$apps[$x]['menu'][$y]['title']['ar-eg'] = "إعدادات المجال";
	...
	$apps[$x]['menu'][$y]['title']['es-mx'] = "Configuración de dominio";
	$apps[$x]['menu'][$y]['title']['fr-ca'] = "Paramètres du domaine";
	...
	$apps[$x]['menu'][$y]['title']['ro-ro'] = "Setări domeniului";
